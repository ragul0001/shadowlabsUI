...
function Explore() {
  ...
  return (
    <div className="bg-[#0c0e1a] relative h-[750px]">
    ...
    />
            ...
            <div className="p-4">
              <div className="relative  my-10">
                ...
                <div className="relative p-8 bg-transparent md:h-[700px] lg:h-[340px] overflow-y-scroll">
                  ...
                  <p className="mt-10 text-justify  ">
                    ...
                    what gaming can achieve, merging the virtual world with
                    fitness routines to create immersive environments that
                    motivate and inspire users.
                  </p>
                  <p className="mt-10 text-justify ">
                    Our advanced technology integration goes beyond gaming, as
                    we seamlessly connect fitness devices and IoT systems to
                    enhance the user experience. Whether it's smartwatches,
                    fitness trackers, or specialized equipment, our games are
                    designed to work flawlessly across all devices, making
                  ...
                  <p className="mt-10 text-justify ">
                    ...
                    gaming, offering unique and secure experiences for users.
                  </p>
                  <p className="mt-10 text-justify">
                    Our commitment to excellence extends to app development as
                    well. We craft robust and scalable applications across
                    platforms, ensuring that whether it's for iOS, Android, or
                    cross-platform development using Flutter or React Native,
                    the result is always a top-notch, user-friendly product.
                  </p>
                  <p className="mt-10 text-justify">
