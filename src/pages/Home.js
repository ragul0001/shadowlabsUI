...
function Home() {
  ...
  <div className="absolute z-10 hidden lg:block w-screen min-w-full min-h-full max-w-none">
    ...
    />
      ...
      {/* Gamifications */}
      <section id="gamification" className="bg-cover bg-center min-h-screen flex items-center justify-center" style={{ backgroundImage: `url(${gamification})` }}>
...
<div className="bg-[#0c0e1a] relative" id="ar">
  <div className="relative w-full h-screen">
    {/* Video embedded inside the section */}
    <ReactPlayer
      url={AR_Development}
      width="100%"
      height="100%"
    ...
    {/* Content section layered on top of the video */}
